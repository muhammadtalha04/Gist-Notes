...
const generateRows = (gists: Gist[], username: string, handleGistView: IDFunc, handleGistEdit: IDFunc, handleGistDelete: IDFunc, handleGistFork: IDFunc, handleGistStar: IDFunc): JSX.Element[] => {
...
const Table: React.FC<TableProps> = ({ gists, loggedIn, username, handleGistView, handleGistEdit, handleGistDelete, handleGistStar, handleGistFork }) => {
    const render = useMemo(() => {
        return generateRows(gists, username, handleGistView, handleGistEdit, handleGistDelete, handleGistFork, handleGistStar);
    }, [gists, username, handleGistView, handleGistEdit, handleGistDelete, handleGistFork, handleGistStar]);
